...
_OPERATION_ID_OVERRIDES = {
    ...
    "operational_copilot.tools.recovery_proposal_read": "copilot_recovery_proposal",
    ...
    "operational_copilot.tools.recovery_day_extension": "copilot_extend_recovery_day",
    "operational_copilot.tools.operational_intake": "copilot_set_operational_intake",
