...
from .http_surface_authority_inspection import RESOURCE_AUTHORITY_INSPECTION_HTTP_OPERATIONS
...
PUBLIC_HTTP_OPERATIONS: tuple[PublicHttpOperation, ...] = (
    ...
    + RESOURCE_AUTHORITY_INSPECTION_HTTP_OPERATIONS
