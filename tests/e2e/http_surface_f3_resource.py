...
F3_RESOURCE_OPERATIONS: tuple[PublicHttpOperation, ...] = (
    ...
    PublicHttpOperation(
        ...
        HttpProbe(
            "/v1/live-workloads",
            body={"workload_key": "probe", "display_name": "Probe"},
        ),
    ),
    PublicHttpOperation(
        "workload.update",
        "POST",
        "/v1/live-workloads/{workload_id}/update",
        "workload.update",
        True,
        True,
        TenantIsolationMode.NOT_FOUND,
        HttpProbe(
            f"/v1/live-workloads/{P1}/update",
            body={"display_name": "Probe", "expected_revision": 1},
        ),
    ),
    PublicHttpOperation(
        "workload.deactivate",
        "POST",
        "/v1/live-workloads/{workload_id}/deactivate",
        "workload.deactivate",
        True,
        True,
        TenantIsolationMode.NOT_FOUND,
        HttpProbe(f"/v1/live-workloads/{P1}/deactivate", body={"expected_revision": 1}),
    ),
)
