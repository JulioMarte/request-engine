...
F3_HTTP_OPERATIONS: tuple[PublicHttpOperation, ...] = (
    PublicHttpOperation(
    ...
    PublicHttpOperation(
        ...
        HttpProbe(f"/v1/service-sessions/{P1}/pause", body={"expected_revision": 1, "kind": "break"}),
    ),
    PublicHttpOperation(
    ...
    PublicHttpOperation(
        "resource_activity.start", "POST", "/v1/resource-activities", "resource_activity.start",
        True, True, TenantIsolationMode.NOT_FOUND,
        HttpProbe("/v1/resource-activities", body={"resource_id": P1, "activity_kind": "break"}),
    ),
    PublicHttpOperation(
        "resource_activity.end", "POST", "/v1/resource-activities/{resource_activity_id}/end",
        "resource_activity.end", True, True, TenantIsolationMode.NOT_FOUND,
        HttpProbe(f"/v1/resource-activities/{P1}/end", body={"expected_revision": 1}),
    ),
    PublicHttpOperation(
        "workload.list", "GET", "/v1/live-workloads", "workload.list",
        False, False, TenantIsolationMode.FILTERED, HttpProbe("/v1/live-workloads"),
    ),
)
