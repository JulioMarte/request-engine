...
_EXPECTED_COLUMNS = {
    ...
    # 0071 Platform Owner readiness/provisioning.
    ("webauthn_credentials", "native_identity_id", "SELECT"),
    ("webauthn_credentials", "status", "SELECT"),
    ("webauthn_credentials", "user_verified", "SELECT"),
    ("recovery_code_sets", "id", "SELECT"),
    ("recovery_code_sets", "native_identity_id", "SELECT"),
    ("recovery_code_sets", "status", "SELECT"),
    ("recovery_codes", "set_id", "SELECT"),
    ("recovery_codes", "used_at", "SELECT"),
    ("platform_owner_policies", "policy_key", "SELECT"),
    ("platform_owner_policies", "revision", "SELECT"),
    ("platform_owner_policies", "grants", "SELECT"),
    ("platform_owner_provisioning_facts", "id", "SELECT"),
    ("platform_owner_provisioning_facts", "principal_id", "SELECT"),
    ("platform_owner_provisioning_facts", "native_identity_id", "SELECT"),
    ("platform_owner_provisioning_facts", "actor_principal_id", "SELECT"),
    ("platform_owner_provisioning_facts", "policy_key", "SELECT"),
    ("platform_owner_provisioning_facts", "provenance_reference", "SELECT"),
    ("platform_owner_provisioning_facts", "idempotency_key_digest", "SELECT"),
    ("platform_owner_provisioning_facts", "intent_digest", "SELECT"),
    ("platform_owner_provisioning_facts", "correlation_id", "SELECT"),
    ("platform_owner_provisioning_facts", "principal_id", "INSERT"),
    ("platform_owner_provisioning_facts", "native_identity_id", "INSERT"),
    ("platform_owner_provisioning_facts", "actor_principal_id", "INSERT"),
    ("platform_owner_provisioning_facts", "policy_key", "INSERT"),
    ("platform_owner_provisioning_facts", "provenance_reference", "INSERT"),
    ("platform_owner_provisioning_facts", "idempotency_key_digest", "INSERT"),
    ("platform_owner_provisioning_facts", "intent_digest", "INSERT"),
    ("platform_owner_provisioning_facts", "correlation_id", "INSERT"),
    # 0072 one-time Platform Owner invitations.
    ("platform_owner_invitations", "id", "SELECT"),
    ("platform_owner_invitations", "token_digest", "SELECT"),
    ("platform_owner_invitations", "token_fingerprint", "SELECT"),
    ("platform_owner_invitations", "status", "SELECT"),
    ("platform_owner_invitations", "revision", "SELECT"),
    ("platform_owner_invitations", "invited_by_principal_id", "SELECT"),
    ("platform_owner_invitations", "native_identity_id", "SELECT"),
    ("platform_owner_invitations", "provenance_reference", "SELECT"),
    ...
    ("platform_owner_invitations", "invited_by_principal_id", "INSERT"),
    ("platform_owner_invitations", "provenance_reference", "INSERT"),
    ("platform_owner_invitations", "idempotency_key_digest", "INSERT"),
    ("platform_owner_invitations", "intent_digest", "INSERT"),
    ("platform_owner_invitations", "expires_at", "INSERT"),
    ("platform_owner_invitations", "status", "UPDATE"),
    ("platform_owner_invitations", "revision", "UPDATE"),
    ("platform_owner_invitations", "native_identity_id", "UPDATE"),
    ...
    ("platform_owner_invitation_facts", "native_identity_id", "INSERT"),
    ("platform_owner_invitation_facts", "revision_before", "INSERT"),
    ("platform_owner_invitation_facts", "revision_after", "INSERT"),
    ("platform_owner_invitation_facts", "correlation_id", "INSERT"),
    ("platform_owner_invitation_facts", "reason_code", "INSERT"),
    ("platform_owner_invitation_facts", "idempotency_key_digest", "INSERT"),
...
_P7_CONFIGURATION_COLUMNS = {
    ...
    ("platform_configuration_facts", "id", "SELECT"),
    ...
    ("platform_secret_mutations", "id", "SELECT"),
    ("platform_secret_mutations", "operation_kind", "SELECT"),
    ("platform_secret_mutations", "capability_key", "SELECT"),
    ("platform_secret_mutations", "actor_principal_id", "SELECT"),
    ("platform_secret_mutations", "actor_authentication_method", "SELECT"),
    ("platform_secret_mutations", "correlation_id", "SELECT"),
    ("platform_secret_mutations", "binding_id", "SELECT"),
    ("platform_secret_mutations", "secret_id", "SELECT"),
    ("platform_secret_mutations", "purpose", "SELECT"),
    ("platform_secret_mutations", "backend", "SELECT"),
    ("platform_secret_mutations", "expected_binding_revision", "SELECT"),
    ("platform_secret_mutations", "expected_backend_version", "SELECT"),
    ("platform_secret_mutations", "applied_backend_version", "SELECT"),
    ("platform_secret_mutations", "state", "SELECT"),
    ("platform_secret_mutations", "idempotency_key_digest", "SELECT"),
    ("platform_secret_mutations", "intent_digest", "SELECT"),
    ("platform_secret_mutations", "result_binding_id", "SELECT"),
    ("platform_secret_mutations", "result_binding_revision", "SELECT"),
    ("platform_secret_mutations", "result_binding_status", "SELECT"),
    ("platform_secret_mutations", "created_at", "SELECT"),
    ("platform_secret_mutations", "backend_applied_at", "SELECT"),
    ("platform_secret_mutations", "committed_at", "SELECT"),
    ("platform_secret_mutations", "reconcile_required_at", "SELECT"),
    ("platform_secret_mutations", "operation_kind", "INSERT"),
    ("platform_secret_mutations", "capability_key", "INSERT"),
    ("platform_secret_mutations", "actor_principal_id", "INSERT"),
    ("platform_secret_mutations", "actor_authentication_method", "INSERT"),
    ("platform_secret_mutations", "correlation_id", "INSERT"),
    ("platform_secret_mutations", "binding_id", "INSERT"),
    ("platform_secret_mutations", "secret_id", "INSERT"),
    ("platform_secret_mutations", "purpose", "INSERT"),
    ("platform_secret_mutations", "backend", "INSERT"),
    ("platform_secret_mutations", "expected_binding_revision", "INSERT"),
    ("platform_secret_mutations", "expected_backend_version", "INSERT"),
    ("platform_secret_mutations", "idempotency_key_digest", "INSERT"),
    ("platform_secret_mutations", "intent_digest", "INSERT"),
    ("platform_secret_mutations", "state", "UPDATE"),
    ("platform_secret_mutations", "applied_backend_version", "UPDATE"),
    ("platform_secret_mutations", "backend_applied_at", "UPDATE"),
    ("platform_secret_mutations", "reconcile_required_at", "UPDATE"),
    ("platform_secret_mutations", "result_binding_id", "UPDATE"),
    ("platform_secret_mutations", "result_binding_revision", "UPDATE"),
    ("platform_secret_mutations", "result_binding_status", "UPDATE"),
