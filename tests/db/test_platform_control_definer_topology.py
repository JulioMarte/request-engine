...
_EXPECTED_COLUMNS = {
    ...
    ("platform_invitation_intents", "consumed_at", "INSERT"),
    ("platform_invitation_intents", "consumed_at", "SELECT"),
    ("platform_invitation_intents", "consumed_at", "UPDATE"),
    ("platform_invitation_intents", "created_at", "INSERT"),
    ("platform_invitation_intents", "created_at", "SELECT"),
    ("platform_invitation_intents", "created_at", "UPDATE"),
    ("platform_invitation_intents", "created_by_principal_id", "INSERT"),
    ("platform_invitation_intents", "created_by_principal_id", "SELECT"),
    ("platform_invitation_intents", "created_by_principal_id", "UPDATE"),
    ("platform_invitation_intents", "expires_at", "INSERT"),
    ("platform_invitation_intents", "expires_at", "SELECT"),
    ("platform_invitation_intents", "expires_at", "UPDATE"),
    ("platform_invitation_intents", "id", "INSERT"),
    ("platform_invitation_intents", "id", "SELECT"),
    ("platform_invitation_intents", "id", "UPDATE"),
    ("platform_invitation_intents", "membership_id", "INSERT"),
    ("platform_invitation_intents", "membership_id", "SELECT"),
    ("platform_invitation_intents", "membership_id", "UPDATE"),
    ("platform_invitation_intents", "proof_digest", "INSERT"),
    ("platform_invitation_intents", "proof_digest", "SELECT"),
    ("platform_invitation_intents", "proof_digest", "UPDATE"),
    ("platform_invitation_intents", "revision", "INSERT"),
    ("platform_invitation_intents", "revision", "SELECT"),
    ("platform_invitation_intents", "revision", "UPDATE"),
    ("platform_invitation_intents", "revoked_at", "INSERT"),
    ("platform_invitation_intents", "revoked_at", "SELECT"),
    ("platform_invitation_intents", "revoked_at", "UPDATE"),
    ("platform_invitation_intents", "status", "INSERT"),
    ("platform_invitation_intents", "status", "SELECT"),
    ("platform_invitation_intents", "status", "UPDATE"),
    ("platform_membership_facts", "action", "INSERT"),
    ("platform_membership_facts", "action", "SELECT"),
    ("platform_membership_facts", "actor_authentication_method", "INSERT"),
    ("platform_membership_facts", "actor_authentication_method", "SELECT"),
    ("platform_membership_facts", "actor_principal_id", "INSERT"),
    ("platform_membership_facts", "actor_principal_id", "SELECT"),
    ("platform_membership_facts", "authority_revision_after", "INSERT"),
    ("platform_membership_facts", "authority_revision_after", "SELECT"),
    ("platform_membership_facts", "capability_key", "INSERT"),
    ("platform_membership_facts", "capability_key", "SELECT"),
    ("platform_membership_facts", "correlation_id", "INSERT"),
    ("platform_membership_facts", "correlation_id", "SELECT"),
    ("platform_membership_facts", "created_at", "INSERT"),
    ("platform_membership_facts", "created_at", "SELECT"),
    ("platform_membership_facts", "id", "INSERT"),
    ("platform_membership_facts", "id", "SELECT"),
    ("platform_membership_facts", "idempotency_key_digest", "INSERT"),
    ("platform_membership_facts", "idempotency_key_digest", "SELECT"),
    ("platform_membership_facts", "intent_digest", "INSERT"),
    ("platform_membership_facts", "intent_digest", "SELECT"),
    ("platform_membership_facts", "membership_id", "INSERT"),
    ("platform_membership_facts", "membership_id", "SELECT"),
    ("platform_membership_facts", "principal_id", "INSERT"),
    ("platform_membership_facts", "principal_id", "SELECT"),
    ("platform_membership_facts", "revision_after", "INSERT"),
    ("platform_membership_facts", "revision_after", "SELECT"),
    ("platform_membership_facts", "revision_before", "INSERT"),
    ("platform_membership_facts", "revision_before", "SELECT"),
    ("platform_memberships", "activated_at", "INSERT"),
    ("platform_memberships", "activated_at", "SELECT"),
    ("platform_memberships", "activated_at", "UPDATE"),
    ("platform_memberships", "created_at", "INSERT"),
    ("platform_memberships", "created_at", "SELECT"),
    ("platform_memberships", "created_at", "UPDATE"),
    ("platform_memberships", "established_by_principal_id", "INSERT"),
    ("platform_memberships", "established_by_principal_id", "SELECT"),
    ("platform_memberships", "established_by_principal_id", "UPDATE"),
    ("platform_memberships", "id", "INSERT"),
    ("platform_memberships", "id", "SELECT"),
    ("platform_memberships", "id", "UPDATE"),
    ("platform_memberships", "identity_binding_id", "INSERT"),
    ("platform_memberships", "identity_binding_id", "SELECT"),
    ("platform_memberships", "identity_binding_id", "UPDATE"),
    ("platform_memberships", "principal_id", "INSERT"),
    ("platform_memberships", "principal_id", "SELECT"),
    ("platform_memberships", "principal_id", "UPDATE"),
    ("platform_memberships", "provenance_kind", "INSERT"),
    ("platform_memberships", "provenance_kind", "SELECT"),
    ("platform_memberships", "provenance_kind", "UPDATE"),
    ("platform_memberships", "provenance_reference", "INSERT"),
    ("platform_memberships", "provenance_reference", "SELECT"),
    ("platform_memberships", "provenance_reference", "UPDATE"),
    ("platform_memberships", "revision", "INSERT"),
    ("platform_memberships", "revision", "SELECT"),
    ("platform_memberships", "revision", "UPDATE"),
    ("platform_memberships", "revoked_at", "INSERT"),
    ("platform_memberships", "revoked_at", "SELECT"),
    ("platform_memberships", "revoked_at", "UPDATE"),
    ("platform_memberships", "status", "INSERT"),
    ("platform_memberships", "status", "SELECT"),
    ("platform_memberships", "status", "UPDATE"),
    ("platform_memberships", "suspended_at", "INSERT"),
    ("platform_memberships", "suspended_at", "SELECT"),
    ("platform_memberships", "suspended_at", "UPDATE"),
    ("principals", "active", "UPDATE"),
}
...
def test_platform_control_definer_has_only_reviewed_columns(
    ...
    table_grants = {
        (cast(str, table), cast(str, privilege))
        for table, privilege in admin_conn.execute(
            """
    ...
    assert table_grants == {
        ...
        ("platform_invitation_intents", "INSERT"),
        ("platform_invitation_intents", "SELECT"),
        ("platform_invitation_intents", "UPDATE"),
        ("platform_membership_facts", "INSERT"),
        ("platform_membership_facts", "SELECT"),
        ("platform_memberships", "INSERT"),
        ("platform_memberships", "SELECT"),
        ("platform_memberships", "UPDATE"),
    }
