...
_EXPECTED_COLUMNS = {
    ...
    # 0065 instance claim: pending setup material + atomic finalize.
    ("platform_instance", "state", "UPDATE"),
    ("platform_instance", "revision", "UPDATE"),
    ("platform_instance", "claimed_at", "UPDATE"),
    ("platform_instance", "initial_owner_principal_id", "UPDATE"),
    ("platform_instance", "claim_provenance", "UPDATE"),
    ("setup_sessions", "status", "UPDATE"),
    ("setup_sessions", "revision", "UPDATE"),
    ("setup_sessions", "consumed_at", "UPDATE"),
    ...
    ("webauthn_credentials", "id", "INSERT"),
    ("webauthn_credentials", "native_identity_id", "INSERT"),
    ("webauthn_credentials", "credential_id", "INSERT"),
    ("webauthn_credentials", "public_key", "INSERT"),
    ("webauthn_credentials", "sign_count", "INSERT"),
    ("webauthn_credentials", "aaguid", "INSERT"),
    ("webauthn_credentials", "backup_eligible", "INSERT"),
    ("webauthn_credentials", "backup_state", "INSERT"),
    ("webauthn_credentials", "user_verified", "INSERT"),
    ("setup_pending_identity", "id", "SELECT"),
    ("setup_pending_identity", "setup_session_id", "SELECT"),
    ("setup_pending_identity", "login_handle", "SELECT"),
    ("setup_pending_identity", "verifier", "SELECT"),
    ("setup_pending_identity", "status", "SELECT"),
    ("setup_pending_identity", "created_at", "SELECT"),
    ("setup_pending_identity", "promoted_at", "SELECT"),
    ("setup_pending_identity", "id", "INSERT"),
    ("setup_pending_identity", "setup_session_id", "INSERT"),
    ("setup_pending_identity", "login_handle", "INSERT"),
    ("setup_pending_identity", "verifier", "INSERT"),
    ("setup_pending_identity", "login_handle", "UPDATE"),
    ("setup_pending_identity", "verifier", "UPDATE"),
    ("setup_pending_identity", "status", "UPDATE"),
    ("setup_pending_identity", "promoted_at", "UPDATE"),
    ("setup_pending_webauthn_credential", "id", "SELECT"),
    ("setup_pending_webauthn_credential", "setup_session_id", "SELECT"),
    ("setup_pending_webauthn_credential", "credential_id", "SELECT"),
    ("setup_pending_webauthn_credential", "public_key", "SELECT"),
    ("setup_pending_webauthn_credential", "sign_count", "SELECT"),
    ("setup_pending_webauthn_credential", "aaguid", "SELECT"),
    ("setup_pending_webauthn_credential", "backup_eligible", "SELECT"),
    ("setup_pending_webauthn_credential", "backup_state", "SELECT"),
    ("setup_pending_webauthn_credential", "user_verified", "SELECT"),
    ("setup_pending_webauthn_credential", "status", "SELECT"),
    ("setup_pending_webauthn_credential", "id", "INSERT"),
    ("setup_pending_webauthn_credential", "setup_session_id", "INSERT"),
    ("setup_pending_webauthn_credential", "credential_id", "INSERT"),
    ("setup_pending_webauthn_credential", "public_key", "INSERT"),
    ("setup_pending_webauthn_credential", "sign_count", "INSERT"),
    ("setup_pending_webauthn_credential", "aaguid", "INSERT"),
    ("setup_pending_webauthn_credential", "backup_eligible", "INSERT"),
    ("setup_pending_webauthn_credential", "backup_state", "INSERT"),
    ("setup_pending_webauthn_credential", "user_verified", "INSERT"),
    ("setup_pending_webauthn_credential", "status", "UPDATE"),
    ("setup_pending_webauthn_credential", "promoted_at", "UPDATE"),
    ("recovery_code_sets", "setup_session_id", "SELECT"),
    ("recovery_code_sets", "native_identity_id", "SELECT"),
    ("recovery_code_sets", "status", "SELECT"),
    ("recovery_code_sets", "setup_session_id", "UPDATE"),
    ("recovery_code_sets", "native_identity_id", "UPDATE"),
    ("platform_owner_policies", "policy_key", "SELECT"),
    ("platform_owner_policies", "revision", "SELECT"),
    ("platform_owner_policies", "grants", "SELECT"),
    ("platform_installation_claim_facts", "instance_id", "SELECT"),
    ("platform_installation_claim_facts", "id", "SELECT"),
    ("platform_installation_claim_facts", "setup_session_id", "SELECT"),
    ("platform_installation_claim_facts", "owner_principal_id", "SELECT"),
    ("platform_installation_claim_facts", "native_identity_id", "SELECT"),
    ("platform_installation_claim_facts", "policy_key", "SELECT"),
    ("platform_installation_claim_facts", "claim_provenance", "SELECT"),
    ("platform_installation_claim_facts", "idempotency_key_digest", "SELECT"),
    ("platform_installation_claim_facts", "intent_digest", "SELECT"),
    ("platform_installation_claim_facts", "correlation_id", "SELECT"),
    ("platform_installation_claim_facts", "created_at", "SELECT"),
    ("platform_installation_claim_facts", "instance_id", "INSERT"),
    ("platform_installation_claim_facts", "setup_session_id", "INSERT"),
    ("platform_installation_claim_facts", "owner_principal_id", "INSERT"),
    ("platform_installation_claim_facts", "native_identity_id", "INSERT"),
    ("platform_installation_claim_facts", "policy_key", "INSERT"),
    ("platform_installation_claim_facts", "claim_provenance", "INSERT"),
    ("platform_installation_claim_facts", "idempotency_key_digest", "INSERT"),
    ("platform_installation_claim_facts", "intent_digest", "INSERT"),
    ("platform_installation_claim_facts", "correlation_id", "INSERT"),
}
