...
ALTER TABLE request_engine.resource_activities
    ADD CONSTRAINT resource_activities_end_actor_ck
...
CREATE OR REPLACE FUNCTION request_engine.guard_resource_activity_transition()
RETURNS trigger LANGUAGE plpgsql AS $function$
BEGIN
...
END
$function$;
DROP TRIGGER IF EXISTS resource_activities_guard_transition
  ON request_engine.resource_activities;
