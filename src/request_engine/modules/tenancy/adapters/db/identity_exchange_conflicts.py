...
_BINDING_IDENTITY_UNIQUE = "organization_party_binding_identity_uq"
...
def is_identity_already_adopted_violation(exc: IntegrityError) -> bool:
    ...
    if constraint is not None:
        return constraint == _BINDING_IDENTITY_UNIQUE
    return f'"{_BINDING_IDENTITY_UNIQUE}"' in str(exc.orig)
