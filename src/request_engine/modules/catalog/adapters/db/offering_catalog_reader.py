...
from request_engine.modules.catalog.adapters.db import offering_mapping
...
"""
            ...
            row = (
                (
                    await session.execute(
                        statement,
                        {"organization_id": organization_id, "offering_key": offering_key},
                    )
                )
                .mappings()
                .first()
        ...
        return offering_mapping.from_row(
            row,
