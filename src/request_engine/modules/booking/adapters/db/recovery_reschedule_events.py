...
def _location(value: UUID | None) -> str | None:
    return str(value) if value is not None else None


async def append_recovery_reschedule_events(
    ...
    *,
    ...
    details: dict[str, object] = {
        ...
        "old_location_id": _location(old_location_id),
        "new_location_id": _location(request.location_id),
