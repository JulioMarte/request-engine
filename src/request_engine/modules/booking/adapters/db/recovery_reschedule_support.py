...
async def lock_reservation_for_recovery(
    ...
    sql = """
        SELECT id, offering_version_id, subject_party_id, location_id, origin_request_id,
...
async def load_active_recovery_claims(
    ...
    sql = """
        SELECT id, resource_id, requirement_id, resource_location_assignment_id, quantity,
