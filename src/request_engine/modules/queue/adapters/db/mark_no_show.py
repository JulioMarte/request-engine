...
from request_engine.modules.queue.application.errors import QueueEntryNotCancellable, QueueEntryRevisionConflict
...
async def mark_no_show(
    session_factory: SessionFactory, command: MarkNoShowCommand
) -> LiveQueueEntry:
        ...
        updated = (
            await session.execute(
                text(
                    ...
                    "RETURNING id,service_queue_id,subject_party_id,reservation_id,offering_id,status,"
