...
def _from_row(row: object) -> DiscoveryCandidate:
    ...
    return DiscoveryCandidate(
        ...
        location_address_line1=cast(str | None, values["location_address_line1"]),
        location_address_line2=cast(str | None, values["location_address_line2"]),
        location_locality=cast(str | None, values["location_locality"]),
        location_administrative_area=cast(str | None, values["location_administrative_area"]),
        location_postal_code=cast(str | None, values["location_postal_code"]),
        location_country_code=cast(str | None, values["location_country_code"]),
        resource_id=cast(UUID | None, values["resource_id"]),
        provider_visibility=cast(str, values["provider_visibility"]),
        provider_key=cast(str | None, values["provider_key"]),
        provider_display_name=cast(str | None, values["provider_display_name"]),
        provider_role_label=cast(str | None, values["provider_role_label"]),
        provider_profile_image_ref=cast(str | None, values["provider_profile_image_ref"]),
