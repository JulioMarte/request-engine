...
IDENTITY_AUTHORITY_CAPABILITIES: tuple[CapabilityDefinition, ...] = (
    ...
    query_capability(
        "platform.owner.read",
        CapabilityExposure.OPERATOR,
        "List and inspect Platform Owners without exposing credentials or recovery material.",
        authority_plane=AuthorityPlane.PLATFORM,
    ),
    command_capability(
        "platform.owner.provision",
        CapabilityExposure.OPERATOR,
        "Promote a prepared native HUMAN identity to Platform Owner authority.",
        authority_plane=AuthorityPlane.PLATFORM,
        revision=RevisionPolicy.SERVER_SELECTED,
        risk_class=OperationRiskClass.AUTHORITY_CHANGE,
    ...
    command_capability(
        ...
        CapabilityExposure.OPERATOR,
        "Suspend, reactivate, or terminally revoke Platform Owner authority.",
        authority_plane=AuthorityPlane.PLATFORM,
        revision=RevisionPolicy.REQUIRED,
        risk_class=OperationRiskClass.AUTHORITY_CHANGE,
        requires_recent_authentication=True,
